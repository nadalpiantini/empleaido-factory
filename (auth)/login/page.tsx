        ...
        <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg p-8 shadow-2xl">
          <div className="space-y-6">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="remember" className="ml-2 block text-slate-400">
                    Remember me
                  </label>
                </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-slate-600 rounded-lg text-slate-300 hover:bg-slate-700/50 hover:text-white transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <p className="text-center text-slate-400 text-sm">
            ...
            <Link href="/register" className="font-medium text-teal-400 hover:text-teal-300 transition">
              Sign up
            </Link>
          </p>
        </div>
